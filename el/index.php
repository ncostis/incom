...
require_once($path."_cm_admin/routes.php");
...
<?php flush(); ?>
<body>
<?php if (Auth::isAdmin() && $_GET['le']=="1") require $path."_cm_admin/live_edit_core.php";?>
<?php
if(getparamvalue('ID') == ""){if ($GetOptRec['Rec_Desc'] == ""){ require $path . "js/js_bodyopen.php";} }else{require $path . "js/js_bodyopen.php";}
if ((getparamvalue('ID') == "") AND ($mobileMode != 1) AND ($GetVar['Rec_Check3']==1)) {
