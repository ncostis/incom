...
if (isset($mobileMode) && $mobileMode == 1) {
    $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Mobile_Active ='Active' AND JS_Script_Position_Mobile='BeforeBodyClose' Order by JS_Active,JS_Order";
} else {
    $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Active ='Active' AND JS_Script_Position='BeforeBodyClose' Order by JS_Active,JS_Order";
}
...
if (!isset($_GET['ID']) || $_GET['ID'] == "") {
    if (isset($mobileMode) && $mobileMode == 1) {
        $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Mobile_Active='HomePage' AND JS_Script_Position_Mobile='BeforeBodyClose' Order by JS_Active,JS_Order";
    } else {
        $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Active='HomePage' AND JS_Script_Position='BeforeBodyClose' Order by JS_Active,JS_Order";
    }
    $GetJS_Query = q($GetJS_Sel);
    while ($GetJS = f($GetJS_Query)) {
        if ($GetJS['JS_Src'] <> "") {
...
if (isset($_GET['ID']) && $_GET['ID'] <> "") {
    if (isset($mobileMode) && $mobileMode == 1) {
        $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Mobile_Active='InsidePage' AND JS_Script_Position_Mobile='BeforeBodyClose' Order by JS_Active,JS_Order";
    } else {
        $GetJS_Sel = "SELECT * FROM javascripts WHERE JS_Active='InsidePage' AND JS_Script_Position='BeforeBodyClose' Order by JS_Active,JS_Order";
    }
    $GetJS_Query = q($GetJS_Sel);
    while ($GetJS = f($GetJS_Query)) {
        if ($GetJS['JS_Src'] <> "") {
