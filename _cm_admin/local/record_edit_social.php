...
<div class="admGridFlexCont">
    <div class="admGridRecL editPanel bgContent <?php if(!$showMediaColumn) echo 'full'?>">
        ...
        <!--    Scrolling1  -->
        <?php if ($GetList['List_Scroll1'] <> "") {
            ?>
            <div class="form-group">
                <label class="formLabel" title="Rec_Scroll1"><?php echo $GetList['List_Scroll1']; ?></label>
                <div class="colInput">
                    <select name="Rec_Scroll1" class="formField">
                        <option value="_blank" selected>_blank</option>
                        <option value="_self" <?php if ($GetRec['Rec_Scroll1'] == "_self") {
                            echo 'selected';
                        } ?>>_self
                        </option>
                    </select>
        ...
        <!--    Scrolling2  -->
        <?php if ($GetList['List_Scroll2'] <> "") {
            ?>
            <div class="form-group">
                <label class="formLabel" title="Rec_Scroll2"><?php echo $GetList['List_Scroll2']; ?></label>
                <div class="colInput">
                    <select name="Rec_Scroll2" class="formField">
                        <option value="" selected>--- select ---</option>
                        <option value="fab fa-facebook-f" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-facebook-f") {
                            echo 'selected';
                        } ?>>Facebook
                        </option>
                        <option value="fab fa-google-plus-g" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-google-plus-g") {
                            echo 'selected';
                        } ?>>Google Plus
                        </option>
                        <option value="fab fa-twitter" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-twitter") {
                            echo 'selected';
                        } ?>>Twitter
                        </option>
                        <option value="fab fa-youtube" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-youtube") {
                            echo 'selected';
                        } ?>>Youtube
                        </option>
                        <option value="fab fa-pinterest-p" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-pinterest-p") {
                            echo 'selected';
                        } ?>>Pinterest
                        </option>
                        <option value="fab fa-flickr" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-flickr") {
                            echo 'selected';
                        } ?>>Flickr
                        </option>
                        <option value="fab fa-tumblr" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-tumblr") {
                            echo 'selected';
                        } ?>>Tumblr
                        </option>
                        <option value="fab fa-instagram" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-instagram") {
                            echo 'selected';
                        } ?>>Instagram
                        </option>
                        <option value="fab fa-foursquare" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-foursquare") {
                            echo 'selected';
                        } ?>>Foursquare
                        </option>
                        <option value="fab fa-linkedin-in" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-linkedin-in") {
                            echo 'selected';
                        } ?>>Linkedin
                        </option>
                        <option value="fab fa-vimeo-v" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-vimeo-v") {
                            echo 'selected';
                        } ?>>Vimeo
                        </option>
                        <option value="fab fa-stumbleupon" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-stumbleupon") {
                            echo 'selected';
                        } ?>>Stumbleupon
                        </option>
                        <option value="fab fa-vk" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-vk") {
                            echo 'selected';
                        } ?>>Vk
                        </option>
                        <option value="fab fa-tripadvisor" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-tripadvisor") {
                            echo 'selected';
                        } ?>>Tripadvisor
                        </option>
                        <option value="fab fa-skype" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-skype") {
                            echo 'selected';
                        } ?>>Skype
                        </option>
                        <option value="fab fa-viber" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-viber") {
                            echo 'selected';
                        } ?>>Viber
                        </option>
                        <option value="fab fa-whatsapp" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-whatsapp") {
                            echo 'selected';
                        } ?>>WhatsApp
                        </option>
                        <option value="fab fa-facebook-messenger" <?php if ($GetRec['Rec_Scroll2'] == "fab fa-facebook-messenger") {
                            echo 'selected';
                        } ?>>Facebook Messenger
                        </option>
                    </select>
        ...
        <?php } ?>
        <!--    Scrolling3  -->
        <?php if ($GetList['List_Scroll3'] <> "" && false) {
            ?>
            <div class="form-group">
                <label class="formLabel" title="Rec_Scroll3"><?php echo $GetList['List_Scroll3']; ?></label>
                <div class="colInput">
                    <select name="Rec_Scroll3" class="formField">
                        <option value="" selected>Normal</option>
                        <option value="fa-lg" <?php if ($GetRec['Rec_Scroll3'] == "fa-lg") {
                            echo 'selected';
                        } ?>>+1
                        </option>
                        <option value="fa-2x" <?php if ($GetRec['Rec_Scroll3'] == "fa-2x") {
                            echo 'selected';
                        } ?>>+2
                        </option>
                        <option value="fa-3x" <?php if ($GetRec['Rec_Scroll3'] == "fa-3x") {
                            echo 'selected';
                        } ?>>+3
                        </option>
                        <option value="fa-4x" <?php if ($GetRec['Rec_Scroll3'] == "fa-4x") {
                            echo 'selected';
                        } ?>>+4
                        </option>
                        <option value="fa-5x" <?php if ($GetRec['Rec_Scroll3'] == "fa-5x") {
                            echo 'selected';
                        } ?>>+5
                        </option>
                    </select>
