...
<div class="admGridFlexCont">
    <div class="admGridRecL editPanel bgContent <?php if(!$showMediaColumn) echo 'full'?>">
        ...
        foreach ($activeFields as $FieldName => $value) {
            ...
            }elseif ((strpos($recField, 'Date') !== false)) {
                        ...
                        <div class="colInput">
                            <select name="Rec_Scroll1" class="formField">
                                <?php for ($i = $yearStart; $i <= $yearEnd; $i++) {
                                    if ($GetRec['Rec_Scroll1'] > 0) $selYear = $GetRec['Rec_Scroll1']; else $selYear = $year; ?>
                                    <option value="<?php echo $i; ?>" <?php if ($i == $selYear) echo 'selected'; ?>><?php echo $i; ?></option>
                                <?php } // for
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="colInput">
                            <select name="Rec_Scroll2" class="formField">
                                <?php for ($im = 1; $im <= 12; $im++) {
                                    ...
                                    if ($GetRec['Rec_Scroll1'] > 0) $selMonth = $GetRec['Rec_Scroll2']; else $selMonth = $month; ?>
                                    <option value="<?php echo $mon; ?>" <?php if ($im == $selMonth) echo 'selected'; ?>><?php echo $mon; ?></option>
                                <?php } // for
                                ?>
                            </select>
                        </div>
