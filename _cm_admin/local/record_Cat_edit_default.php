...
<div class="topInternalTitle bgLighter <?php if($GetRec['Rec_Active']=='1') echo 'bgInactive'?>">
    <h2>
        <span class="cMedium"><i class="fas fa-pen"></i></span> <span class="cMedium"><small><?php echo $GetSection['Section_Title'];?> > <?php echo $GetPage['Page_Name']; ?> ></small></span> <?php echo $GetRec['Rec_Title']?>
    </h2>
    <div class="gridTitleRight">
        ...
        <?php if (($accAdm['Acc_Categories'] == 1) OR (Auth::accessLevel() == 0)) { ?>
            ...
            <section style="display:none" class="bgLight">
                <ul>
                    <li>
                        <a class="popUpWindow admLink cDefault btn bgLight" href="rel_pages_view.php?Rec_ID=<?php echo $GetRec['Rec_ID']; ?>" data-width="92%" data-height="94%">
            ...
            <div class="admGrid2Cols">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="colInput">
                            <?Php
                            $RecListsTemp_Sel = "SELECT * FROM lists_templates";
                            $RecListsTemp_Query = q($RecListsTemp_Sel);
                            ?>
