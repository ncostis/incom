...
document.writeln(
    ...
    '/* Calendar background */' +
    'table.scw                  {background-color:  #99a2d0;}' +
    '/* Drag Handle */' +
    'td.scwDrag                 {background-color:  #9999CC;' +
    'color:             #CCCCFF;}' +
    '/* Week number heading */' +
    'td.scwWeekNumberHead       {color:             #99a2d0;}' +
    '/* Week day headings */' +
    'td.scwWeek                 {color:             #f8f8f8;}' +
    '/* Week numbers */' +
    'td.scwWeekNo               {background-color:  #776677;' +
    'color:             #f8f8f8;}' +
    '/* Enabled Days */' +
    '/* Week Day */' +
    'td.scwCells                {background-color:  #f8f8f8;' +
    'color:             #000000;}' +
    '/* Day matching the input date */' +
    'td.scwInputDate            {background-color:  #CC9999;' +
    'color:             #FF0000;}' +
    '/* Weekend Day */' +
    'td.scwCellsWeekend         {background-color:  #f8f8f8;' +
    'color:             #CC6666;}' +
    '/* Day outside the current month */' +
    'td.scwCellsExMonth         {background-color:  #f8f8f8;' +
    'color:             #666666;}' +
    '/* Today selector */' +
    'td.scwFoot                 {background-color:  #99a2d0;' +
    'color:             #FFFFFF;}' +
    ...
    'color:             #666666;}' +
    'td.scwFootDisabled         {background-color:  #99a2d0;' +
    'color:             #FFFFFF;}' +
    '</style>'
);
        ...
        function scwInputFormat() {
            ...
            switch (scwArrInput.length) {
                ...
                case 2: {// Year and Month entry
                    scwArrSeed[0] =
                        parseInt(scwArrInput[scwDateSequence.replace(/D/i, '').search(/Y/i)], 10);  // Year
                ...
                case 3: {// Day Month and Year entry
                    ...
                    scwArrSeed[0] =
                        parseInt(scwArrInput[scwDateSequence.search(/Y/i)], 10);  // Year
                    scwArrSeed[1] = scwArrInput[scwDateSequence.search(/M/i)];      // Month
                    scwArrSeed[2] =
                        parseInt(scwArrInput[scwDateSequence.search(/D/i)], 10);  // Day
