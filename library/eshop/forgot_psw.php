...
<head>
    ...
    <?php
    $path = "../../";
    require $path . "_cm_admin/libraries/mysql_condb.php";
    require $path . "_cm_admin/initvars.php";
    require $path . "library/functions.php";
...
<div style="padding-left:100px; padding-top:30px; padding-bottom:10px;">
    <!--<img src="<?php echo $rootURL; ?>elements/send_to_friend_title.png" alt="" />-->
...
<div style="padding-left:100px; padding-top:10px;">
    ...
    if (($userEmail <> "") AND ($error == "")) {
		...
		";
            ...
            print "
			<div style='padding-top:30px;'>Password has been sent to e-mail: <b>$userEmail</b></div>";
        } else {
            print "
			<div style='padding-top:30px;'>E-mail does not exist in our database<b>$userEmail</b></div>";
        }
