...
$GetPages_Sel = "SELECT * FROM pages, records WHERE Parent_Page_ID = '$Page_ID' AND Rec_Page_ID = Page_ID AND Rec_Page_Content = '1' AND Rec_Active = 0 Order by Page_Order";
