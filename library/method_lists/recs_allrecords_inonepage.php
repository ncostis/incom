<?php
$GetRecs_Sel = "SELECT * FROM pages, records WHERE Page_View = '$ID' AND Rec_Page_ID = Page_ID AND Rec_Page_Content = '0' AND Rec_Active = 0 AND Page_Lang = '$Lang' Order by Rec_DateStart Desc, Rec_Order";
