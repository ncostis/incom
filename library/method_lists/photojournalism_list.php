...
<?php
// SET UP INSTRUCTIONS
// Show Title: Rat_Check1  ---- Disable Popup Image: Rat_Check2
// Display Method: Rat_Field28
// Custom image width: Rat_Field29
    ...
    while ($GetRatRec = f($GetRatRecs_Query)) {
        ...
        if (($GetRatRec['Rat_Field28'] == "img_text") OR ($GetRatRec['Rat_Field28'] == "text_img")) {
            ...
            if ($GetRatRec['Rat_Check2'] == 0) {
                ...
                print "<div align=center><a href=\"$imgzoom1\" id=\"photorepIm\"><figure style=\"margin: auto;\"><img src=\"$imgzoom1\" style=\"$imageSize\" border=0 onmouseover=\"this.style.opacity=0.7;this.filters.alpha.opacity=70\" onmouseout=\"this.style.opacity=1;this.filters.alpha.opacity=100\"><figcaption>".$GetRatRec["Rat_Field1"]."</figcaption></figure></a></div>";
            }
            ...
            <div class="<?php echo $gridImage; ?>" style="float:<?php echo $align; ?>">
                <div class="<?php echo $gridImageItem; ?>">
                    ...
                    if ($GetRatRec['Rat_Check2'] == 1) {
                        ...
                        print "</div>";
                        print "<a href=\"$imgzoom1\" id=\"photorepIm\"><figure style=\"margin: auto;\"><img src=\"$imgzoom1\" style=\"$imageSize\" border=0 onmouseover=\"this.style.opacity=0.7;this.filters.alpha.opacity=70\" onmouseout=\"this.style.opacity=1;this.filters.alpha.opacity=100\"><figcaption>".$GetRatRec["Rat_Field1"]."</figcaption></figure></a>";
                    } else {
        ...
        if (($GetRatRec['Rat_Field28'] == "imgs_below") OR ($GetRatRec['Rat_Field28'] == "imgs_top")) {
            ...
            if ($GetRatRec['Rat_Check2'] == 0) {
                ...
                print "<a href=\"$imgzoom2\" id=\"photorepIm\"><figure style=\"margin: auto;\"><img src=\"$imgzoom2\" style=\"$imageSize\" border=0 onmouseover=\"this.style.opacity=0.7;this.filters.alpha.opacity=70\" onmouseout=\"this.style.opacity=1;this.filters.alpha.opacity=100\"><figcaption>".$GetRatRec["Rat_Field1"]."</figcaption></figure></a>";
            }
            print "</div>";
            print "</div>";
