...
$PageMod_Sel = "SELECT * FROM pages, records WHERE Page_ID = $ModPageID AND Page_ID = Rec_Page_ID AND Rec_ShowHome = 1 AND Rec_Page_Content = $modHeadCont AND Rec_Active = 0 $orderString LIMIT $StartAt,$limitRecs";
