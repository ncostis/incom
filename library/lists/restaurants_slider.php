...
var accRestaurants = $('.bxRestaurants').bxSlider({
...
<?php if($mobileMode<>1){ ?>
    $(".accPager .rest-prev").click(function(e){
        e.preventDefault();
        accRestaurants.goToPrevSlide();
    });
    $(".accPager .rest-next").click(function(e){
        e.preventDefault();
        accRestaurants.goToNextSlide();
    });
<?php } ?>
});
</script>
...
print "</div>";
 if($mobileMode<>1){
print"<a href=\"#\" class=\"rest-prev\"></a>";
print"<a href=\"#\" class=\"rest-next\"></a>";
}
print"</div>";
?>  