...
var accRestaurants = $('.bxExperiences').bxSlider({
...
<?php if($mobileMode<>1){ ?>
    $(".accPager .exp-prev").click(function(e){
        e.preventDefault();
        accRestaurants.goToPrevSlide();
    });
    $(".accPager .exp-next").click(function(e){
        e.preventDefault();
...
print "</div>";
 if($mobileMode<>1){
print"<a href=\"#\" class=\"exp-prev\"></a>";
print"<a href=\"#\" class=\"exp-next\"></a>";
}
print"</div>";
?>