...
var accSlider = $('.bxExplore').bxSlider({
...
<?php if($mobileMode<>1){ ?>
    $(".accPager .explore-prev").click(function(e){
        e.preventDefault();
        accSlider.goToPrevSlide();
    });
    $(".accPager .explore-next").click(function(e){
        e.preventDefault();
...
print "</div>";
 if($mobileMode<>1){
print"<a href=\"#\" class=\"explore-prev\"></a>";
print"<a href=\"#\" class=\"explore-next\"></a>";
}
print"</div>";
?>
