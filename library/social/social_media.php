<div class="center flexBox">
    ...
    <?php
    if($ModFieldText <> ""){print "<div class=\"followUs\">".$ModFieldText."</div>";}
    $Mod_Query = q($Mod_Sel);
    ...
    while ($GetSocial = f($GetSocial_Query)) {
        ...
        if ($GetSocial['Rec_TextArea1'] <> '') {
            ...
            ?>
            <a href="<?php echo $link; ?>" target="<?php echo $target; ?>" rel="noopener" class="wow fadeIn social" data-wow-delay="<?=$wdelay?>">
                <?php if ($socialImg <> '') { ?>
                ...
                <?php } else {
                    ...
                    <i class="fas <?php echo $socialFont; ?> <?php echo $socialSize; ?>" width="<?php echo $socialWidth; ?>" height="<?php echo $socialHeight; ?>" title="<?php echo $socialTitle ?>" alt="<?php echo $socialTitle ?>"></i>
                <?php } ?>
            </a>
            <?php
        }
